...
import PersonImage from "../assets/person3.jpg";
import Button from "./Button";

const Hero = () => (
  <section className="max-w-7xl mx-auto px-6 flex flex-col-reverse gap-10 py-10 pb-20 lg:flex-row-reverse lg:gap-28 lg:py-20">
    {/* Text Content */}
    <div className="flex flex-1 flex-col justify-center space-y-6 xl:w-1/2 z-20 text-center lg:text-left">
      <h1 className="text-gray-700 text-2xl sm:text-2xl md:text-5xl lg:text-5xl font-bold">
      Where creators can easily create
      </h1>
